<!-- converted from ai_scm_study_20260422.docx -->


AI 공급망 인텔리전스 리포트
AI Supply Chain Intelligence — 심층 학습 자료
기준일: 2026-04-11  |  분석 범위: 2018-2028
...
| --- | --- | --- | --- |
| HBM 메모리 | 99% | 🔴 위험 | 18개월 (신규 팹) |
| CoWoS 패키징 | 66% | 🟡 보통 | 12개월 (TSMC 확장) |
| 전력/DC 인프라 | 87% | 🔴 위험 | 24개월 (변압기 리드타임) |
| 네트워킹 | 80% | 🟠 높음 | 6개월 |
| GPU 서버 | 85% | 🔴 위험 | 9개월 (Blackwell 램프) |
| Foundry | 84% | 🟠 높음 | N/A |
| 커스텀 ASIC | 78% | 🟠 높음 | 12개월 |
| DRAM | 62% | 🟡 보통 | 6개월 |
| SSD 스토리지 | 42% | 🟢 낮음 | 3개월 |
...
| Amazon | - | $38B | $48B | $75B | $105B | $130B |
| Meta | - | $31B | $28B | $37B | $65B | $72B |
| xAI | - | - | - | $6B | $15B | $30B |
| Oracle | - | $4B | $7B | $11B | $16B | $20B |
