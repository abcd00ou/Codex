...
- 발행자: Lawrence Berkeley National Laboratory / DOE
- 날짜: 2024-12
...
- 발행자: Congressional Research Service
- 날짜: 2026
...
| ID | 자료 | 발행자 | 날짜 | 용도 | 링크 |
|---|---|---|---|---|---|
| S01 | IEA, Energy and AI | IEA | 2025 | 데이터센터 전력 수요와 AI 전력 전망의 macro baseline | https://www.iea.org/reports/energy-and-ai |
| S02 | 2024 United States Data Center Energy Usage Report | Lawrence Berkeley National Laboratory / DOE | 2024-12 | 미국 데이터센터 에너지 사용, AI server 추정, water/power baseline | https://buildings.lbl.gov/publications/2024-lbnl-data-center-energy-usage-report |
| S03 | Data Centers and Their Energy Consumption: Frequently Asked Questions | Congressional Research Service | 2026 | 미국 정책/전력망 관점의 데이터센터 FAQ | https://www.congress.gov/crs-product/R48646 |
| S04 | Electricity Demand and Grid Impacts of AI Data Centers | arXiv | 2025 | AI 데이터센터 부하 특성과 전력망 영향 review | https://arxiv.org/abs/2509.07218 |
| S05 | Scaling Laws for Neural Language Models | Kaplan et al., arXiv | 2020 | 훈련 compute, parameter, data 간 scaling law | https://arxiv.org/abs/2001.08361 |
| S06 | Training Compute-Optimal Large Language Models | Hoffmann et al., arXiv | 2022 | Chinchilla compute-optimal scaling, parameter/token allocation | https://arxiv.org/abs/2203.15556 |
| S07 | Training compute of frontier AI models grows by 4-5x per year | Epoch AI | 2024 | frontier training compute trend | https://epoch.ai/blog/training-compute-of-frontier-ai-models-grows-by-4-5x-per-year |
| S08 | How much power will frontier AI training demand in 2030? | Epoch AI | 2025 | single frontier training run의 전력 수요 추정 | https://epoch.ai/blog/power-demands-of-frontier-ai-training/ |
| S09 | Efficient Memory Management for LLM Serving with PagedAttention | Kwon et al., arXiv | 2023 | KV cache, batching, serving throughput bottleneck | https://arxiv.org/abs/2309.06180 |
| S10 | Splitwise: Efficient generative LLM inference using phase splitting | Patel et al., arXiv | 2023 | prefill/decode 분리와 power/cost 최적화 | https://arxiv.org/abs/2311.18677 |
| S11 | DistServe: Disaggregating Prefill and Decoding | Zhong et al., arXiv | 2024 | TTFT/TPOT SLO와 prefill/decode resource allocation | https://arxiv.org/abs/2401.09670 |
| S12 | Google Ironwood TPU: age of inference | Google Cloud | 2025-04-09 | inference-oriented accelerator와 TPU serving 방향 | https://blog.google/products/google-cloud/ironwood-tpu-age-of-inference/ |
| S13 | Cloud TPU inference documentation | Google Cloud | accessed 2026-05-14 | serving quota와 inference deployment 개념 | https://docs.cloud.google.com/tpu/docs/v5e-inference |
| S14 | AWS Trainium | AWS | accessed 2026-05-14 | training/inference용 custom accelerator positioning | https://aws.amazon.com/ai/machine-learning/trainium/ |
| S15 | Amazon and Anthropic expand strategic collaboration | Amazon | 2024 | Claude, Trainium, Bedrock inference attribution 사례 | https://www.aboutamazon.com/news/company-news/amazon-invests-additional-5-billion-anthropic-ai/ |
| S16 | OpenAI compute infrastructure / Stargate | OpenAI | 2025-2026 | planned capacity와 model-owner compute 전략 사례 | https://openai.com/index/building-the-compute-infrastructure-for-the-intelligence-age/ |
