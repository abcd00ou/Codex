...
| A01_E004 | FACT_OPENAI_STARGATE_10GW; FACT_ANTHROPIC_AWS_5GW | 2026-05-27 | Audit finding | OpenAI 12GW and Anthropic 7GW model endpoints extend beyond registered cited values; endpoints remain scenario until new disclosure replaces them | GW modeled endpoints | contracted_power_gw | High for classification | Codex |
...
- A cited public capacity anchor and a modeled endpoint are separate objects; `02c_fact_vs_assumption_audit` must display both.
